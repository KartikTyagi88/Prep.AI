  ...
  return (
    <div>
      <div className="bg-[url('\martin-martz-3_x1FRGAEwY-unsplash.jpg')] bg-cover bg-center w-full">
        <div className="min-h-screen flex flex-col items-center justify-center text-center p-4">
          ...
          <div className="space-x-4">
            ...
            <Link to="/signup">
              <button className="bg-green-600 text-white px-6 py-2 rounded bg-linear-to-r from-green-300 from 25% to-emerald-500 to-90% font-bold">Signup</button>
            </Link>
          </div>
        </div>
      </div>
      <footer className="footer sm:footer-horizontal bg-gray-900 text-base-content p-10">
        <nav>
          <h6 className="footer-title font-bold text-gray-200">Services</h6>
        ...
        <nav>
          <h6 className="footer-title font-bold text-gray-200">Company</h6>
        ...
        <nav>
          <h6 className="footer-title font-bold text-gray-200">Social</h6>
